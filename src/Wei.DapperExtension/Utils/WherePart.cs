...
namespace Wei.DapperExtension.Utils
{
    internal class WherePart
    {
        ...
        public DynamicParameters DynamicParameters
        {
            get
            {
                ...
                if (HasSql)
                {
                    ...
                    {
                        dynamicParameters.Add(param.Key, param.Value, param.Type);
                    }
                }
        ...
        public static WherePart IsSql(string sql) => new WherePart(sql);

        public static WherePart IsParameter(int count, object value) => new WherePart($"@{count}", new Parameter(count.ToString(), value));
        ...
        public static WherePart Concat(string @operator, WherePart operand) => new WherePart($"({@operator} {operand.Sql})", operand.Parameters);
